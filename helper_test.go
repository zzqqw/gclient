...
func TestMd5(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := Md5String(tt.args.str); got != tt.want {
...
func TestMd5File(t *testing.T) {
	tests := []struct {
		...
		{
			name: "test1",
			path: "./.testdata/ico.png",
			want: "50c90e57bafc4e32409690233c2f9568",
		},
		{
			name: "test2",
			path: "./.testdata/ico.png",
...
func TestSha1(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := Sha1String(tt.args.str); got != tt.want {
